...
#[doc = "Field `REVGLB` reader - Global Result Event - REVGLB"]
pub type REVGLB_R = crate::BitReader<bool>;
#[doc = "Field `REVGLB` writer - Global Result Event - REVGLB"]
pub type REVGLB_W<'a, const O: u8> = crate::BitWriter<'a, u32, GLOBEFLAG_SPEC, bool, O>;
#[doc = "Field `REVGLBCLR` writer - Clear Global Result Event - REVGLBCLR"]
pub type REVGLBCLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GLOBEFLAG_SPEC, bool, O>;
impl R {
    #[doc = "Bit 8 - Global Result Event - REVGLB"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 24 - Clear Global Result Event - REVGLBCLR"]
    #[inline(always)]
    #[must_use]
