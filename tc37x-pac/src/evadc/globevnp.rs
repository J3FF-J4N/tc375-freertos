...
#[doc = "Field `REV0NP` reader - Service Request Node Pointer Global Result"]
pub type REV0NP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `REV0NP` writer - Service Request Node Pointer Global Result"]
pub type REV0NP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GLOBEVNP_SPEC, u8, u8, 4, O>;
impl R {
