...
pub type DRCTR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GLOBRCR_SPEC, u8, u8, 4, O>;
...
pub type WFR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GLOBRCR_SPEC, bool, O>;
...
pub type SRGEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, GLOBRCR_SPEC, bool, O>;
impl R {
