...
#[doc = "Field `CMPVAL` reader - Compare Value of Compare Register x - CMPVAL"]
pub type CMPVAL_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CMPVAL` writer - Compare Value of Compare Register x - CMPVAL"]
pub type CMPVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Compare Value of Compare Register x - CMPVAL"]
    #[inline(always)]
    pub fn cmpval(&self) -> CMPVAL_R {
        CMPVAL_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Compare Value of Compare Register x - CMPVAL"]
    #[inline(always)]
    #[must_use]
    pub fn cmpval(&mut self) -> CMPVAL_W<0> {
        CMPVAL_W::new(self)
    }
