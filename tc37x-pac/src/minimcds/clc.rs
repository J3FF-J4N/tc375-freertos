...
#[doc = "Field `DISR` reader - Disable Request Bit - DISR"]
pub type DISR_R = crate::BitReader<bool>;
#[doc = "Field `DISR` writer - Disable Request Bit - DISR"]
pub type DISR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLC_SPEC, bool, O>;
#[doc = "Field `DISS` reader - Disable Status Bit - DISS"]
pub type DISS_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - Disable Request Bit - DISR"]
    #[inline(always)]
    pub fn disr(&self) -> DISR_R {
        DISR_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Disable Status Bit - DISS"]
    #[inline(always)]
