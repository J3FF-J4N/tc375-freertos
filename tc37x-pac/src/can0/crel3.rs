...
#[doc = "Register `CREL3` reader"]
pub struct R(crate::R<CREL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CREL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CREL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CREL3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Core Release Register 3\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [crel3](index.html) module"]
pub struct CREL3_SPEC;
impl crate::RegisterSpec for CREL3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [crel3::R](R) reader structure"]
impl crate::Readable for CREL3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CREL3 to value 0x3215_0320"]
impl crate::Resettable for CREL3_SPEC {
