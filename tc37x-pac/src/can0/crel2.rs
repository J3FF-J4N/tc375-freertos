...
#[doc = "Register `CREL2` reader"]
pub struct R(crate::R<CREL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CREL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CREL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CREL2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Core Release Register 2\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [crel2](index.html) module"]
pub struct CREL2_SPEC;
impl crate::RegisterSpec for CREL2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [crel2::R](R) reader structure"]
impl crate::Readable for CREL2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CREL2 to value 0x3215_0320"]
impl crate::Resettable for CREL2_SPEC {
