...
#[doc = "Field `DISR` reader - DAM Disable Request Bit - DISR"]
pub type DISR_R = crate::BitReader<bool>;
#[doc = "Field `DISR` writer - DAM Disable Request Bit - DISR"]
pub type DISR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLC_SPEC, bool, O>;
#[doc = "Field `DISS` reader - DAM Disable Status Bit - DISS"]
pub type DISS_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - DAM Disable Request Bit - DISR"]
    #[inline(always)]
    pub fn disr(&self) -> DISR_R {
        DISR_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - DAM Disable Status Bit - DISS"]
    #[inline(always)]
