...
#[doc = "Field `DADR` reader - Destination Address Register (Pointer) - DADR"]
pub type DADR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DADR` writer - Destination Address Register (Pointer) - DADR"]
pub type DADR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DADR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Destination Address Register (Pointer) - DADR"]
    #[inline(always)]
...
#[doc = "`reset()` method sets DADR to value 0"]
