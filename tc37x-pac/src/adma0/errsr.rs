...
#[doc = "Field `SE` reader - System Error - SE"]
pub type SE_R = crate::BitReader<bool>;
#[doc = "Field `SRI_ECC` reader - System Memory ECC Error - SRI_ECC"]
pub type SRI_ECC_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - Memory Error - ME"]
    #[inline(always)]
    pub fn me(&self) -> ME_R {
        ME_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - System Error - SE"]
    #[inline(always)]
    pub fn se(&self) -> SE_R {
        SE_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - System Memory ECC Error - SRI_ECC"]
    #[inline(always)]
    pub fn sri_ecc(&self) -> SRI_ECC_R {
        SRI_ECC_R::new(((self.bits >> 2) & 1) != 0)
    }
}
