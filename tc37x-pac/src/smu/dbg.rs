...
#[doc = "Field `SSM` reader - Running state of the SMU_core State Machine - SSM"]
pub type SSM_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:1 - Running state of the SMU_core State Machine - SSM"]
    #[inline(always)]
    pub fn ssm(&self) -> SSM_R {
        SSM_R::new((self.bits & 3) as u8)
    }
}
