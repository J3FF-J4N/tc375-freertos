...
#[doc = "Field `MOD_TYPE` reader - Module Number Value - MOD_TYPE"]
pub type MOD_TYPE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MOD_NUM` reader - Module Number Value - MOD_NUM"]
pub type MOD_NUM_R = crate::FieldReader<u16, u16>;
impl R {
    ...
    #[doc = "Bits 8:15 - Module Number Value - MOD_TYPE"]
    #[inline(always)]
    pub fn mod_type(&self) -> MOD_TYPE_R {
        MOD_TYPE_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:31 - Module Number Value - MOD_NUM"]
    #[inline(always)]
    pub fn mod_num(&self) -> MOD_NUM_R {
        MOD_NUM_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
...
#[doc = "`reset()` method sets ID to value 0x00cc_c002"]
impl crate::Resettable for ID_SPEC {
    const RESET_VALUE: Self::Ux = 0x00cc_c002;
}
