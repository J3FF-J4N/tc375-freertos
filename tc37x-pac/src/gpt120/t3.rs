...
#[doc = "Field `T3` reader - Timer T3 - T3"]
pub type T3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `T3` writer - Timer T3 - T3"]
pub type T3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T3_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Timer T3 - T3"]
    #[inline(always)]
    pub fn t3(&self) -> T3_R {
        T3_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Timer T3 - T3"]
...
#[doc = "`reset()` method sets T3 to value 0"]
