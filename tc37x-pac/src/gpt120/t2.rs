...
#[doc = "Field `T2` reader - Timer T2 - T2"]
pub type T2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `T2` writer - Timer T2 - T2"]
pub type T2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T2_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Timer T2 - T2"]
    #[inline(always)]
    pub fn t2(&self) -> T2_R {
        T2_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Timer T2 - T2"]
...
#[doc = "`reset()` method sets T2 to value 0"]
