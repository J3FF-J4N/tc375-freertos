...
#[doc = "Field `T4` reader - Timer T4 - T4"]
pub type T4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `T4` writer - Timer T4 - T4"]
pub type T4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T4_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Timer T4 - T4"]
    #[inline(always)]
    pub fn t4(&self) -> T4_R {
        T4_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Timer T4 - T4"]
...
#[doc = "`reset()` method sets T4 to value 0"]
