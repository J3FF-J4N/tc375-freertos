...
pub type MODNUM_R = crate::FieldReader<u8, u8>;
impl R {
    ...
    #[doc = "Bits 8:15 - Module Number Value - MODNUM"]
    #[inline(always)]
    pub fn modnum(&self) -> MODNUM_R {
        MODNUM_R::new(((self.bits >> 8) & 0xff) as u8)
    }
}
...
#[doc = "`reset()` method sets ID to value 0x5400"]
