...
#[doc = "Field `TGS` reader - Trigger Set for OTGB0/1 - TGS"]
pub type TGS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TGS` writer - Trigger Set for OTGB0/1 - TGS"]
pub type TGS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OCS_SPEC, u8, u8, 2, O>;
#[doc = "Field `TGB` reader - OTGB0/1 Bus Select - TGB"]
pub type TGB_R = crate::BitReader<bool>;
#[doc = "Field `TGB` writer - OTGB0/1 Bus Select - TGB"]
pub type TGB_W<'a, const O: u8> = crate::BitWriter<'a, u32, OCS_SPEC, bool, O>;
#[doc = "Field `TG_P` writer - TGS, TGB Write Protection - TG_P"]
...
impl R {
    #[doc = "Bits 0:1 - Trigger Set for OTGB0/1 - TGS"]
    #[inline(always)]
    pub fn tgs(&self) -> TGS_R {
        TGS_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 2 - OTGB0/1 Bus Select - TGB"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 3 - TGS, TGB Write Protection - TG_P"]
    #[inline(always)]
    #[must_use]
