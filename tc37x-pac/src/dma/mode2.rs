...
#[doc = "Field `MODE` reader - Resource Partition Supervisor Mode - MODE"]
pub type MODE_R = crate::BitReader<bool>;
#[doc = "Field `MODE` writer - Resource Partition Supervisor Mode - MODE"]
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE2_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Resource Partition Supervisor Mode - MODE"]
    #[inline(always)]
...
#[doc = "`reset()` method sets MODE2 to value 0x01"]
