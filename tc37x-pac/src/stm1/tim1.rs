...
#[doc = "Field `STM_35_4` reader - System Timer Bits \\[35:4\\]
- STM\\[35:4\\]"]
pub type STM_35_4_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - System Timer Bits \\[35:4\\]
- STM\\[35:4\\]"]
    #[inline(always)]
    pub fn stm_35_4(&self) -> STM_35_4_R {
        STM_35_4_R::new(self.bits)
    }
}
