...
#[doc = "Register `CREL1` reader"]
pub struct R(crate::R<CREL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CREL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CREL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CREL1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Core Release Register 1\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [crel1](index.html) module"]
pub struct CREL1_SPEC;
impl crate::RegisterSpec for CREL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [crel1::R](R) reader structure"]
impl crate::Readable for CREL1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CREL1 to value 0x3215_0320"]
impl crate::Resettable for CREL1_SPEC {
