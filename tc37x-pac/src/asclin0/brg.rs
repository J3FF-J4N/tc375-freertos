...
#[doc = "Field `DENOMINATOR` reader - Denominator - DENOMINATOR"]
pub type DENOMINATOR_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DENOMINATOR` writer - Denominator - DENOMINATOR"]
pub type DENOMINATOR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BRG_SPEC, u16, u16, 12, O>;
#[doc = "Field `NUMERATOR` reader - Numerator - NUMERATOR"]
pub type NUMERATOR_R = crate::FieldReader<u16, u16>;
#[doc = "Field `NUMERATOR` writer - Numerator - NUMERATOR"]
pub type NUMERATOR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BRG_SPEC, u16, u16, 12, O>;
impl R {
    #[doc = "Bits 0:11 - Denominator - DENOMINATOR"]
    #[inline(always)]
    pub fn denominator(&self) -> DENOMINATOR_R {
        DENOMINATOR_R::new((self.bits & 0x0fff) as u16)
    }
    #[doc = "Bits 16:27 - Numerator - NUMERATOR"]
    #[inline(always)]
    pub fn numerator(&self) -> NUMERATOR_R {
        NUMERATOR_R::new(((self.bits >> 16) & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11 - Denominator - DENOMINATOR"]
    #[inline(always)]
    #[must_use]
    pub fn denominator(&mut self) -> DENOMINATOR_W<0> {
        DENOMINATOR_W::new(self)
    }
    #[doc = "Bits 16:27 - Numerator - NUMERATOR"]
    #[inline(always)]
    #[must_use]
    pub fn numerator(&mut self) -> NUMERATOR_W<16> {
        NUMERATOR_W::new(self)
    }
