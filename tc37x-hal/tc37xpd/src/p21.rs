...
impl P21 {
    ...
    #[doc = "Port 21 Output Modification Clear Register\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 21 Output Modification Clear Register 0\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 21 Output Modification Clear Register 4\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 21 Output Modification Register\n resetvalue={:0x0}"]
    #[inline(always)]
    pub const fn omr(&self) -> crate::common::Reg<self::Omr_SPEC, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.0.add(4usize)) }
    }

    #[doc = "Port 21 Output Modification Set Register\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 21 Output Modification Set Register 0\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 21 Output Modification Set Register 4\n resetvalue={:0x0}"]
    #[inline(always)]
...
impl Iocr4 {
    #[doc = "Port Control for Port 21 Pin 7. This bit field defines the Port n line x functionality according to Table          only input selection apply."]
    #[inline(always)]
    pub fn pc4(
        self,
...
impl Lpcr {
    #[doc = "LVDS RX EN controller. The LVDS RX EN control function can be selected from the Port  default         or HSCT module  where this is connected ."]
    #[inline(always)]
    pub fn ren_ctrl(
        self,
    ) -> crate::common::RegisterField<0, 0x1, 1, 0, lpcr::RenCtrl, Lpcr_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x1,1,0,lpcr::RenCtrl, Lpcr_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Enable Receive LVDS. Enable the receive LVDS   disable CMOS path. If this bit is set to 0   8211         no transfer from the LVDS sender can be received and the receiver LVDS        is in low power state. Driven to LVDS pad control   8220 LVDSEN  8221 ."]
    #[inline(always)]
    pub fn rx_en(
        self,
    ) -> crate::common::RegisterField<1, 0x1, 1, 0, lpcr::RxEn, Lpcr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x1,1,0,lpcr::RxEn, Lpcr_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Select Receiver Termination Mode. Selects a suitable internal load resistor between both pads. Driven to LVDS pad control   8220 RTERM EN  8221 ."]
    #[inline(always)]
    pub fn term(
        self,
    ) -> crate::common::RegisterField<2, 0x1, 1, 0, lpcr::Term, Lpcr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<2,0x1,1,0,lpcr::Term, Lpcr_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "LVDS RX Poly resistor configuration value. Programming bits for the on die poly resistor termination. The value is        configured during production test. Each chip configuration on this bit        field is unique and configured during production testing. Please  check PHY design specification for detailed configuration          values. The value is configured by Startup SW during start up phase of          the chip Driven to LVDS pad control   8220 RTERM PROG 2 0   8221  The configuration value shall not be changed by user after start up          for a guaranteed behavior."]
    #[inline(always)]
    pub fn lrxterm(
        self,
    ) -> crate::common::RegisterField<3, 0x7, 1, 0, u8, Lpcr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x7,1,0,u8, Lpcr_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "LVDS M Mode. Selects reduced frequency mode   8220 LVDS M  8221  of the receiver. This mode        reduces the static current of the RX pad. The max data rate is reduced        to 160  160 Mbps  80  160 MHz . Driven to LVDS pad control   8220 LVDS MEN  8221 ."]
    #[inline(always)]
    pub fn lvdsm(
        self,
    ) -> crate::common::RegisterField<6, 0x1, 1, 0, lpcr::Lvdsm, Lpcr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<6,0x1,1,0,lpcr::Lvdsm, Lpcr_SPEC,crate::common::RW>::from_register(self,0)
    }
...
pub mod lpcr {
    pub struct RenCtrl_SPEC;
    pub type RenCtrl = crate::EnumBitfieldStruct<u8, RenCtrl_SPEC>;
    impl RenCtrl {
    ...
    pub struct Term_SPEC;
    pub type Term = crate::EnumBitfieldStruct<u8, Term_SPEC>;
    impl Term {
        #[doc = "0 external        termination   on the PCB"]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "1 100  160   8486  Receiver        internal termination"]
        pub const CONST_11: Self = Self::new(1);
    }
    pub struct Lvdsm_SPEC;
    pub type Lvdsm = crate::EnumBitfieldStruct<u8, Lvdsm_SPEC>;
    impl Lvdsm {
        #[doc = "0 LVDS H Mode"]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "1 LVDS M Mode"]
