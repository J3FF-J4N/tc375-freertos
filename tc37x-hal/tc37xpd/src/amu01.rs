...
pub struct Amu01(pub(super) *mut u8);
unsafe impl core::marker::Send for Amu01 {}
unsafe impl core::marker::Sync for Amu01 {}
impl Amu01 {
...
impl Ctrl0 {
    ...
    pub fn sdown(
        self,
    ) -> crate::common::RegisterField<3, 0x3, 1, 0, ctrl0::Sdown, Ctrl0_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<3,0x3,1,0,ctrl0::Sdown, Ctrl0_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn cshs(
        self,
    ) -> crate::common::RegisterField<30, 0x3, 1, 0, ctrl0::Cshs, Ctrl0_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<30,0x3,1,0,ctrl0::Cshs, Ctrl0_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
pub mod ctrl0 {
    pub struct Sdown_SPEC;
    pub type Sdown = crate::EnumBitfieldStruct<u8, Sdown_SPEC>;
    impl Sdown {
        #[doc = "00 Full Speed  SDOWN FULL"]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "01 Half Speed  SDOWN HALF"]
        pub const CONST_11: Self = Self::new(1);
        #[doc = "10 Speed    SDOWN QUARTER"]
        pub const CONST_22: Self = Self::new(2);
        #[doc = "11 Speed 1 8  SDOWN ONE8TH"]
        pub const CONST_33: Self = Self::new(3);
    }
    pub struct Cshs_SPEC;
    pub type Cshs = crate::EnumBitfieldStruct<u8, Cshs_SPEC>;
    impl Cshs {
        #[doc = "00 Current Shaping Off"]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "01 Running at SDOWN 1 prio to shifting up to full speed set by SDOWN."]
        pub const CONST_11: Self = Self::new(1);
        #[doc = "10 Normal  speed set by SDOWN"]
        pub const CONST_22: Self = Self::new(2);
        #[doc = "11 Shifted down to SDOWN 1 for final stage before completion"]
        pub const CONST_33: Self = Self::new(3);
    }
}
#[doc(hidden)]
...
impl Ctrl0Mir {
    ...
    pub fn sdown(
        self,
    ) -> crate::common::RegisterField<3, 0x3, 1, 0, ctrl0mir::Sdown, Ctrl0Mir_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<3,0x3,1,0,ctrl0mir::Sdown, Ctrl0Mir_SPEC,crate::common::R>::from_register(self,0)
    }
    ...
    pub fn cshs(
        self,
    ) -> crate::common::RegisterField<30, 0x3, 1, 0, ctrl0mir::Cshs, Ctrl0Mir_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<30,0x3,1,0,ctrl0mir::Cshs, Ctrl0Mir_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
impl Ctrl1 {
    ...
    pub fn vfrmt(
        self,
    ) -> crate::common::RegisterField<16, 0x3, 1, 0, ctrl1::Vfrmt, Ctrl1_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<16,0x3,1,0,ctrl1::Vfrmt, Ctrl1_SPEC,crate::common::RW>::from_register(self,0)
    }
...
pub mod ctrl1 {
    pub struct Vfrmt_SPEC;
    pub type Vfrmt = crate::EnumBitfieldStruct<u8, Vfrmt_SPEC>;
    impl Vfrmt {
        #[doc = "00 V is stored as 32 bit IEEE single precision float"]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "01 V is stored as 16 bit IEEE half precision float"]
        pub const CONST_11: Self = Self::new(1);
        #[doc = "10 V is stored as a 16 bit fixed point number. Exponent is fixed and stored in EXPFIX"]
        pub const CONST_22: Self = Self::new(2);
    }
}
#[doc(hidden)]
...
impl Eer {
    ...
    pub fn ecc_stop(
        self,
    ) -> crate::common::RegisterField<15, 0x1, 1, 0, eer::EccStop, Eer_SPEC, crate::common::R> {
        crate::common::RegisterField::<15,0x1,1,0,eer::EccStop, Eer_SPEC,crate::common::R>::from_register(self,0)
    }
...
pub mod eer {
    pub struct EccStop_SPEC;
    pub type EccStop = crate::EnumBitfieldStruct<u8, EccStop_SPEC>;
    impl EccStop {
        #[doc = "0 ECC errors on SRI accesses will be ignored."]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "1 ECC errors on SRI accesses will stop execution and cause an interrupt"]
        pub const CONST_11: Self = Self::new(1);
    }
}
#[doc(hidden)]
...
impl Errsr {
    ...
    #[doc = "Correctable Memory Error   MEC. Read as 0  must be written with 0"]
    #[inline(always)]
    pub fn res(self) -> crate::common::RegisterFieldBool<12, 1, 0, Errsr_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<12, 1, 0, Errsr_SPEC, crate::common::R>::from_register(
            self, 0,
        )
    }
    ...
    #[doc = "Corrected Memory Error   CME. Read as 0  must be written with 0"]
    #[inline(always)]
    pub fn res14(self) -> crate::common::RegisterFieldBool<14, 1, 0, Errsr_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<14, 1, 0, Errsr_SPEC, crate::common::R>::from_register(
            self, 0,
        )
    }
...
impl P7Sint {
    #[doc = "Max Iteration Counter for Inner Loop   M. This register contains the column dimension of matrix V. It is the maximum number of iterations of the inner loop of the algorithm.Due to hardware constraints  this value cannot be larger than 20."]
    #[inline(always)]
    pub fn m(
        self,
