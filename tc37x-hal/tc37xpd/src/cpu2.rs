...
pub struct Cpu2(pub(super) *mut u8);
unsafe impl core::marker::Send for Cpu2 {}
unsafe impl core::marker::Sync for Cpu2 {}
impl Cpu2 {
    ...
    #[doc = "CPUx Flash Configuration Register 0\n resetvalue={Application Reset:0x3F3F3F3F,CFS Value:0x0}"]
    #[inline(always)]
...
impl core::default::Default for Flashcon0 {
    ...
    fn default() -> Flashcon0 {
        <crate::RegValueT<Flashcon0_SPEC> as RegisterValue<_>>::new(0)
    }
}
