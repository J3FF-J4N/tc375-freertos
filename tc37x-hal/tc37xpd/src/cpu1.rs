...
pub struct Cpu1(pub(super) *mut u8);
unsafe impl core::marker::Send for Cpu1 {}
unsafe impl core::marker::Sync for Cpu1 {}
impl Cpu1 {
    ...
    #[doc = "CPUx Flash Configuration Register 0\n resetvalue={Application Reset:0x3F3F3F3F,CFS Value:0x22202021}"]
    #[inline(always)]
...
impl core::default::Default for Flashcon0 {
    ...
    fn default() -> Flashcon0 {
        <crate::RegValueT<Flashcon0_SPEC> as RegisterValue<_>>::new(572530721)
    }
}
