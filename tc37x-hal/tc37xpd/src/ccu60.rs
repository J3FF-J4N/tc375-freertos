...
impl Mosel {
    ...
    pub fn trig0sel(
        self,
    ) -> crate::common::RegisterField<0, 0x7, 1, 0, mosel::Trig0Sel, Mosel_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x7,1,0,mosel::Trig0Sel, Mosel_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Output Trigger Select for CCU6061 TRIG2. This bit field defines the output signal from the CCU6061 module used as        the trigger signal to the EVADC inputs."]
    #[inline(always)]
    pub fn trig1sel(
        self,
    ) -> crate::common::RegisterField<3, 0x7, 1, 0, mosel::Trig1Sel, Mosel_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<3,0x7,1,0,mosel::Trig1Sel, Mosel_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Output Trigger Select for CCU6061 TRIG2. This bit field defines the output signal from the CCU6061 module used as        the trigger signal to the EVADC inputs."]
    #[inline(always)]
    pub fn trig2sel(
        self,
    ) -> crate::common::RegisterField<6, 0x7, 1, 0, mosel::Trig2Sel, Mosel_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<6,0x7,1,0,mosel::Trig2Sel, Mosel_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
pub mod mosel {
    pub struct Trig0Sel_SPEC;
    pub type Trig0Sel = crate::EnumBitfieldStruct<u8, Trig0Sel_SPEC>;
    impl Trig0Sel {
        #[doc = "000 The signal        CCU60 COUT63 is selected."]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "001 The signal CCU61 COUT63 is selected."]
        pub const CONST_11: Self = Self::new(1);
        #[doc = "The signal CCU60 CC62 is selected."]
        pub const CONST_22: Self = Self::new(2);
        #[doc = "The signal CCU61 CC62 is selected."]
        pub const CONST_33: Self = Self::new(3);
        #[doc = "100 The signal        CCU60 SR1 is selected."]
        pub const CONST_44: Self = Self::new(4);
        #[doc = "101 The signal        CCU61 SR1 is selected."]
        pub const CONST_55: Self = Self::new(5);
        #[doc = "110 The signal        CCU60 SR3 is selected."]
        pub const CONST_66: Self = Self::new(6);
        #[doc = "111 The signal        CCU61 SR3 is selected."]
        pub const CONST_77: Self = Self::new(7);
    }
    pub struct Trig1Sel_SPEC;
    pub type Trig1Sel = crate::EnumBitfieldStruct<u8, Trig1Sel_SPEC>;
    impl Trig1Sel {
        #[doc = "000 The signal        CCU60 COUT63 is selected."]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "001 The signal CCU61 COUT63 is selected."]
    ...
    pub struct Trig2Sel_SPEC;
    pub type Trig2Sel = crate::EnumBitfieldStruct<u8, Trig2Sel_SPEC>;
    impl Trig2Sel {
        #[doc = "000 The signal        CCU60 COUT63 is selected."]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "001 The signal CCU61 COUT63 is selected."]
