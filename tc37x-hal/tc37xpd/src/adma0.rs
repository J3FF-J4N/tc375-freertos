...
impl Oda {
    ...
    pub fn ddren(
        self,
    ) -> crate::common::RegisterField<0, 0x1, 1, 0, oda::Ddren, Oda_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x1,1,0,oda::Ddren, Oda_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Destructive Read Enable   DREN. For details see CROSSREFERENCE ."]
    #[inline(always)]
    pub fn dren(
        self,
    ) -> crate::common::RegisterField<1, 0x1, 1, 0, oda::Dren, Oda_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x1,1,0,oda::Dren, Oda_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
pub mod oda {
    ...
    impl Ddren {
        #[doc = "0 Destructive read for debug read accesses are disabled"]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "1 Destructive read for debug read accesses are enabled"]
        pub const CONST_11: Self = Self::new(1);
    }
    pub struct Dren_SPEC;
    pub type Dren = crate::EnumBitfieldStruct<u8, Dren_SPEC>;
    impl Dren {
        #[doc = "0 Destructive read for all read accesses except debug read accesses. Destructive read for debug read accesses must be separately enabled by setting DDREN to 1"]
        pub const CONST_00: Self = Self::new(0);
        #[doc = "1 Destructive read for all read accesses are disabled"]
        pub const CONST_11: Self = Self::new(1);
    }
}
#[doc(hidden)]
